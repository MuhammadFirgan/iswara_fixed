...
export default function Card({ image, title, name, profile, slug, nip }: CardProps) {
  return (
    <div className="group relative w-full md:w-52 rounded overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 glass glass-hover p-2 h-72 md:h-80">
